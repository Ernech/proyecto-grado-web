    ...
    <div class="main">
        <div class="basic-info">
            ...
            <h3 v-if="jobCallStore.applyPersonalData && jobCallStore.applyCVData.length>0">
                <b>Nombre: </b>{{applyPersonalData.name}} {{applyPersonalData.firstLastName}} {{applyPersonalData.secondLastName}} 
            </h3>
            <h3 v-else><b>Nombre: </b>--</h3>
            <button class="get-word-file-button">
...
export default {
    ...
    setup(props) {
        ...
        return { jobCallStore ,applyPersonalData}
    }
}
</script>
